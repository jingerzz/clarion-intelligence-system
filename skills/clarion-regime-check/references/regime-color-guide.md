...
Crash regime. Maximum defense. Buffett rule: in this regime, the lesson of every prior cycle is "live to fight again."
...
Example: in ORANGE with rf = 4.5%, hurdle = 4.5% + 4.0% = **8.5%**.
